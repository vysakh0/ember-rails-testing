...
function stubEndpointForHttpRequest(url, status, json) {
    $.mockjax({
            url: url,
            status: status,
            dataType: 'json',
...
function loginUser() {
  stubEndpointForHttpRequest('/api/users/current', 200, {user: {id: 1, email: 'yolo@gmail.com', slug: "vyo", username: "cool", name: "yolo"}})
}
